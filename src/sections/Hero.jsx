...
const Hero = () => {
  return (
    ...
    >
      <div className="w-full bg-black bg-opacity-50 h-full items-center justify-center flex flex-col">
        <h1 className="text-brand-lavender-light font-wedding text-8xl">
          Nails By Tay
        </h1>
